...
public class FunctionCallAlphabet
{
	public static void main( String[] args )
	{
		...
		f("F");    // displays the word you pass it beginning with "F"
		...
		x(1);    // returns a different word depending on what you pass it (1-2)
		y();    // displays a word beginning with Y
		z(false,false);    // returns a different word depending on which two boolean values you pass it
		System.out.println();
	}
